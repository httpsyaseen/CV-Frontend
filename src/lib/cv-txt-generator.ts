...
export const convertCVToTxt = (
  ...
  if (cvData.previousExperiences && cvData.previousExperiences.length > 0) {
    ...
    lines.push("=".repeat(50));
    lines.push("");
    lines.push("No previous experience provided.");
    lines.push("");
  }
  ...
  lines.push("=".repeat(50));
  lines.push("");
  lines.push(cvData.teachingExperience || "No teaching experience provided.");
  lines.push("");
  ...
  lines.push("=".repeat(50));
  lines.push("");
  lines.push(cvData.researchExperience || "No research experience provided.");
  lines.push("");
  ...
  lines.push(
    cvData.leadershipManagementExperience ||
      "No leadership/management experience provided."
  );
  lines.push("");
  ...
  lines.push(
    cvData.auditQualityImprovementExperience ||
      "No QIP/audit experience provided."
  );
  lines.push("");
  ...
  lines.push(
    cvData.clinicalSkillsProcedureCompetency ||
      "No clinical skills/procedures provided."
  );
  lines.push("");
  ...
  lines.push("=".repeat(50));
  lines.push("");
  lines.push(cvData.personalStatement || "No personal statement provided.");
  lines.push("");
